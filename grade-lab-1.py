...
@test(5, "rhmm, test coalesce basic 1")
...
@test(5, "rhmm, test coalesce basic 2")
def test_coalesce_basic1():
...
@test(5, "rhmm, test force alignment")
...
@test(5, "rhmm, test too small blocks")
...
@test(5, "rhmm, test gracefully run out of memory")
...
@test(5, "rhmm, test stress big heap chunks")
...
@test(5, "rhmm, test stress overlapping")
